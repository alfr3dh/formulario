...
$('.tabs a').click(function(e){
  e.preventDefault();
	...
	$('.qrcfromsubmit').submit(function(){
		$('.qrcs_sdhi').addClass("fancyLoaderCss");
		$('.qrccomposer_djkfhjhj').hide();
		var b=$(this).serialize();
		$.post('options.php',b).error(function(){
			alert('error')}).success(function(){
				$(".qrcs_sdhi").removeClass("fancyLoaderCss");
				$('.qrccomposer_djkfhjhj').show();
				$('.qrccomposer_djkfhjhj').html('<span class="dashicons dashicons-saved"></span>')});return!1});

	$('.vacradsubmits').submit(function(){
		...
		$.post('options.php',b).error(function(){
			alert('error')}).success(function(){
				...
				$('.qrcvcard_djkfhjhj').html('<span class="dashicons dashicons-saved"></span>')});return!1});
		...
		});})(jQuery);(function($){$(document).ready(function(){"use strict";$(function(){$('.qrc-color-picker').wpColorPicker();$('.qrc-bgcolor-picker').wpColorPicker()})})})(jQuery);
