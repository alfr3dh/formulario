...
class Qrc_composer_Admin
{
    ...
    public function __construct($plugin_name, $version)
    {
        ...
        require_once plugin_dir_path(dirname(__FILE__)) . 'admin/class_qrc_shortodedocs.php';
        ...
        $plugin_name = new QRC_litecodeDOcs();
    ...
    public function enqueue_scripts()
    {
      ...
      if (isset($_GET['page']) && strpos($_GET['page'], QRC_COMPOSER_PLUGIN_ID) !== false){      
        ...
        wp_enqueue_script('wp-color-picker-alpha', QRC_COMPOSER_URL . 'admin/js/wp-color-picker-alpha.js', array(
            'jquery'
        ) , $this->version, true); 
    ...
    public function plugin_settings_link($links)
    {
        ...
        return array_merge(array(
            ...
            '<a class="qrccompoer_pro_link" href="https://sharabindu.com/plugins/qr-code-composer/">' . __('Go Pro', 'qr-code-composer') . '</a>',
        ) , $links);
