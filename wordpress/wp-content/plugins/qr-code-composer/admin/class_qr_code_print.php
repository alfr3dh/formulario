...
class QR_code_Print_light{
    ...
    ?>       
                <option><?php echo $post_type_title
        ->labels->name; ?></option>
    ...
    function qr_print_per_page()
    {
        ...
        printf('<input type="text" class="regular-text"  value="7" placeholder="QR Code Per Page"><p class="description"></p>', $placeholder);
    }
    ...
    ?>
       ...
       <?php  $terms = get_terms(array(
        ...
        <option><?php echo $woo_category->name; ?></option>
    ...
    <select id="qr_print_cat_ty">
        ...
        <option><?php echo $el_category->name .' - ('. $post_type_title->labels->name .')'; ?></option>
    ...
    <select id="qr_print_tzx_ty">
        ...
        <option><?php echo $taxonomy .' - ('. $post_type_title->labels->name .')'; ?></option>
